...
class CustomUserAdmin(UserAdmin):
    ...
    model = CustomUser
    list_display = CustomUser.ADMIN_LIST_DISPLAY + ('is_active', 'activate_button')
    list_filter = CustomUser.ADMIN_LIST_FILTER
    fieldsets = (
        (None, {'fields': ('email', 'username', 'password')}),
        ('Personal info', {'fields': ('first_name', 'last_name', 'phone_number', 'profile_picture', 'date_of_birth', 'gender', 'country')}),
